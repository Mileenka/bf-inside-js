...
const _1_expect = true; // 1 is equal to 1
const _1_native = '1' <= 1;
console.assert(_1_expect === _1_native, 'Test 1');

const _2_expect = false; // true is not less than or equal to null
const _2_native = true <= null;
console.assert(_2_expect === _2_native, 'Test 2');

const _3_expect = true; // false is less than or equal to null (after conversion to Number)
const _3_native = false <= null;
console.assert(_3_expect === _3_native, 'Test 3');

const _4_expect = true; // '0.0' is less than or equal to false (after conversion to Number)
const _4_native = '0.0' <= false;
console.assert(_4_expect === _4_native, 'Test 4');

const _5_expect = true; // false is less than true
const _5_native = false <= true;
console.assert(_5_expect === _5_native, 'Test 5');

const _6_expect = false; // '13' is not less than or equal to true (numerically)
const _6_native = '13' <= true;
console.assert(_6_expect === _6_native, 'Test 6');

const _7_expect = true; // 'aa' is less than 'ab' lexicographically
const _7_native = 'aa' <= 'ab';
console.assert(_7_expect === _7_native, 'Test 7');

const _8_expect = true; // 'aa' is considered equal to 'aa'
const _8_native = 'aa' <= 'aa';
console.assert(_8_expect === _8_native, 'Test 8');

const _9_expect = true; // 0 is less than or equal to '' (after conversion to Number)
const _9_native = 0 <= '';
