...
const _1_expect = false; // 1 is not less than 1
const _1_native = '1' < 1;
console.assert(_1_expect === _1_native, 'Test 1');

const _2_expect = false; // 0 is not less than 0
const _2_native = '' < null;
console.assert(_2_expect === _2_native, 'Test 2');

const _3_expect = false; // undefined and null are not comparable
const _3_native = undefined < null;
console.assert(_3_expect === _3_native, 'Test 3');

const _4_expect = false; // '0.0' is not less than false numerically
...
const _6_expect = false; // '13' is not less than true numerically
...
const _8_expect = false; // 'aa' is considered equal to 'aa'
const _8_native = 'aa' < 'aa';
console.assert(_8_expect === _8_native, 'Test 8');

const _9_expect = false; // 0 is not less than '' numerically
const _9_native = 0 < '';
